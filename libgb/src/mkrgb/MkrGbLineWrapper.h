#ifndef MKRGBLINEWRAPPER_H
#define MKRGBLINEWRAPPER_H
...
class MkrGbLineWrapper : public BlackT::TLineWrapper {
public:
  typedef std::map<int, int> CharSizeTable;

  MkrGbLineWrapper(BlackT::TStream& src__,
//                  BlackT::TStream& dst__,
                  ...
                  int xSize__ = -1,
                  int ySize__ = -1,
                  int controlOpsEnd__ = default_controlOpsEnd);
...
//  };
  ...
  const static int default_controlOpsEnd = 0x20;
